<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastroFuncionario.aspx.cs" Inherits="AppGerenteBarber.paginas.cadastros.CadastroFuncionario" %>
...
<head>
    ...
    <title>Gerente barber - Cadastro funcionário</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cadastro funcionário</h1>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                       <div class="form-floating">
                                            <input type="text" class="form-control" id="inputDescricao" placeholder="Nome funcionário">
                                            <label for="inputDescricao">Nome funcionário</label>
                                        </div>
                                        ...
                                        <div class="mt-2">
                                            <button class="btn btn-success mr-2" onclick="adicionarFuncionario()">Salvar</button>
                                            <button class="btn btn-secondary" onclick="listaFuncionario()">Cancelar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
