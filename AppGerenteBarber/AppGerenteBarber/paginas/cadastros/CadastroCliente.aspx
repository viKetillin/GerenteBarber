<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastroCliente.aspx.cs" Inherits="AppGerenteBarber.paginas.cadastros.CadastroCliente" %>
                                ...
                                <div class="card-body">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                       <div class="form-floating">
                                            <input type="text" class="form-control" id="inputDescricao" placeholder="Nome cliente">
                                            <label for="inputDescricao">Nome cliente</label>
                                        </div>
                                        ...
                                        <div class="mt-2">
                                            <button class="btn btn-success mr-2" onclick="adicionarCliente()">Salvar</button>
                                            <button class="btn btn-secondary" onclick="listaCliente()">Cancelar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
